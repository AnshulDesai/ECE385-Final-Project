	lab8_soc u0 (
		...
		.bluegenerate_export    (<connected-to-bluegenerate_export>),    //    bluegenerate.export
		.clk_clk                (<connected-to-clk_clk>),                //             clk.clk
		.keycode_export         (<connected-to-keycode_export>),         //         keycode.export
		.keyinput_wire_export   (<connected-to-keyinput_wire_export>),   //   keyinput_wire.export
		.orangegenerate_export  (<connected-to-orangegenerate_export>),  //  orangegenerate.export
		...
		.pinkgenerate_export    (<connected-to-pinkgenerate_export>),    //    pinkgenerate.export
		.redgenerate_export     (<connected-to-redgenerate_export>),     //     redgenerate.export
